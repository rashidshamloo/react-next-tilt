 ...
 */var $t=n,Ft=Symbol.for("react.element"),Pt=Symbol.for("react.fragment"),Nt=Object.prototype.hasOwnProperty,Wt=$t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,zt={key:!0,ref:!0,__self:!0,__source:!0};function St(o,a,c){var l,u={},s=null,H=null;c!==void 0&&(s=""+c),a.key!==void 0&&(s=""+a.key),a.ref!==void 0&&(H=a.ref);for(l in a)Nt.call(a,l)&&!zt.hasOwnProperty(l)&&(u[l]=a[l]);if(o&&o.defaultProps)for(l in a=o.defaultProps,a)u[l]===void 0&&(u[l]=a[l]);return{$$typeof:Ft,type:o,key:s,ref:H,props:u,_owner:Wt.current}}pe.Fragment=Pt;pe.jsx=St;pe.jsxs=St;Mt.exports=pe;var i=Mt.exports;const h=(o,a,c)=>o<a?a:o>c?c:o,Ut=(o,a,c)=>{let l=0;return a==="top"?l=(o.offsetY*2-1)*-1:a==="bottom"?l=(o.offsetY-.5)*2:a==="left"?l=(o.offsetX*2-1)*-1:a==="right"&&(l=(o.offsetX-.5)*2),(l*c).toFixed(2)},Jt=(o,a,c)=>{let l=o.offsetX,u=o.offsetY;c||(l=1-l,u=1-u);let s="translateX(0deg) translateY(0deg)";return a==="top"?s=`translateX( ${l*50}% )`:a==="bottom"?s=`translateX( ${l*50}% ) translateY(50%)`:a==="left"?s=`translateY( ${u*50}% )`:a==="right"&&(s=`translateX(50%) translateY( ${u*50}% ) `),s},Kt=(o,a,c)=>{let l=o.offsetX,u=o.offsetY;a==="top-right"&&(l=1-l),a==="bottom-left"&&(u=1-u),a==="bottom-right"&&(l=1-l,u=1-u);let s=0;return c?s=((l+u)*(3/2)-1)*100:s=((l+u)*(-3/2)+.5)*100,`translateX(${s}%)`},De=o=>{if(o instanceof HTMLElement)return o;if(o instanceof Document)return document;if(o.current)return o.current},de=n.forwardRef(({width:o,height:a,borderRadius:c,perspective:l="1000px",scale:u=1,lineGlareEnable:s=!0,lineGlareBlurEnable:H=!0,lineGlareBlurAmount:Ge="4px",lineGlareMaxOpacity:Gt=.1,lineGlareWidthPercent:C=10,lineGlareMixBlendMode:Et="normal",lineGlareColor:Ee="white",lineGlareReverse:O=!1,lineGlareDirection:wt="to-bottom-right",lineGlareHoverPosition:we="top-left",spotGlareEnable:Rt=!0,spotGlareMaxOpacity:Re=.5,spotGlareMixBlendMode:Tt="normal",spotGlarePosition:me="top",spotGlareColor:Ct="white",spotGlareReverse:Te=!1,tiltMaxAngleX:x=20,tiltMaxAngleY:k=20,tiltReverse:Ce=!1,tiltReset:z=!0,initialAngleX:v=0,initialAngleY:b=0,disableScrollOnTouch:M=!0,style:qt,tiltStyle:Vt,tiltProps:Lt,gyroMaxAngleX:S=0,gyroMaxAngleY:G=0,gyroReverse:qe=!1,disabled:d=!1,disabledFilter:Dt="grayscale(1) brightness(125%)",CSSTransition:fe="all 0.4s cubic-bezier(0.03, 0.98, 0.52, 0.99)",TiltWrapper:Xt=({children:p})=>i.jsx(i.Fragment,{children:p}),fullPageListening:q=!1,controlElement:E,controlElementOnly:At=!1,testIdEnable:V=!1,onTilt:he,onMouseEnter:ge,onMouseMove:ve,onMouseLeave:be,onTouchStart:ye,onTouchMove:xe,onTouchEnd:ke,onBlur:Me,children:Yt,...Ht},Ot)=>{const p=n.useRef(),j=n.useRef(!1),R=!q&&(!E||E&&!At),B=n.useRef(null),T=n.useRef(null),g=n.useRef(null),w=n.useRef(null);s&&(C=h(C,0,50)/2),x=h(x,0,90),k=h(k,0,90),S=h(S,0,90),G=h(G,0,90),v&&(v=h(v,-x,x)),b&&(b=h(b,-k,k));const U=n.useMemo(()=>s?(100-C)/2:0,[s,C]),Ve=n.useMemo(()=>s?U+C:0,[s,C,U]),L=n.useCallback(()=>{if(!B.current||!g.current||!p.current)return;const e=Ut(p.current,me,Re),t=Jt(p.current,me,Te);requestAnimationFrame(()=>{g.current&&(g.current.style.opacity=e,g.current.style.transform=t)})},[me,Re,Te]),D=n.useCallback(()=>{if(!B.current||!w.current||!p.current)return;const e=Kt(p.current,we,O);requestAnimationFrame(()=>{w.current&&(w.current.style.transform=e)})},[we,O]),X=n.useCallback((e=!0)=>{if(!B.current||!p.current)return{angleX:0,angleY:0};let t=-(p.current.offsetY-.5)*2*x,r=(p.current.offsetX-.5)*2*k;return Ce&&e&&(t=-t,r=-r),{angleX:t,angleY:r}},[x,k,Ce]),Le=n.useCallback(e=>{const t=(e.angleY/k+1)/2,r=(-e.angleX/x+1)/2;p.current={offsetX:t,offsetY:r}},[x,k]),A=n.useCallback((e,t=!0)=>{const r=t?u:1;requestAnimationFrame(()=>{T.current&&(T.current.style.transform=`rotateX(${e.angleX}deg) rotateY(${e.angleY}deg) scale3d(${r},${r},${r})`)}),he&&he({angleX:e.angleX,angleY:e.angleY})},[he,u]),Y=n.useCallback((e,t=!1)=>{Le(e),A(e,t),D(),L()},[D,Le,L,A]),y=n.useCallback(()=>{v||b?Y({angleX:v||0,angleY:b||0}):(p.current=void 0,requestAnimationFrame(()=>{w.current&&(w.current.style.transform=`translateX(${O?"50%":"-100%"})`),g.current&&(g.current.style.transform="translateX(0%)",g.current.style.opacity="0"),T.current&&(T.current.style.transform="rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)")}))},[v,b,O,Y]),J=n.useCallback((e,t)=>{if(!t)return;if(q&&t instanceof Document){p.current={offsetX:e.x/window.innerWidth,offsetY:e.y/window.innerHeight};return}const r=t.getBoundingClientRect();if(!r.width||!r.height)return;const jt=h(e.x,r.left,r.right),Bt=h(e.y,r.top,r.bottom),_t=(jt-r.left)/r.width,It=(Bt-r.top)/r.height;p.current={offsetX:_t,offsetY:It}},[q]),f=n.useCallback((e=!0)=>{T.current&&(T.current.style.willChange=e?"transform":""),g.current&&(g.current.style.willChange=e?"transform, opacity":""),w.current&&(w.current.style.willChange=e?"transform":"")},[]);n.useImperativeHandle(Ot,()=>({tilt:Y,reset:y,angle:()=>X(!1),updateWillChange:f,element:B.current}),[Y,y,f,X]);const _=n.useCallback(()=>{d||(j.current=!0,f())},[d,f]),I=n.useCallback(()=>{d||(M&&(typeof M=="boolean"?document.body.style.overflow="hidden":M.style.overflow="hidden"),j.current=!0,f())},[M,d,f]),$=n.useCallback(e=>{d||(J({x:e.clientX,y:e.clientY},e.currentTarget),A(X()),D(),L())},[d,X,J,A,D,L]),F=n.useCallback(e=>{if(d)return;const t=e.changedTouches[0];t&&(J({x:t.clientX,y:t.clientY},e.currentTarget),A(X()),D(),L())},[d,X,J,A,D,L]),P=n.useCallback(()=>{d||(j.current=!1,f(!1),z&&y())},[d,y,z,f]),N=n.useCallback(()=>{d||(M&&(typeof M=="boolean"?document.body.style.overflow="":M.style.overflow=""),j.current=!1,f(!1),z&&y())},[M,d,y,z,f]),W=n.useCallback(()=>{d||y()},[d,y]);n.useEffect(()=>{if(!E&&!q)return;let e;q||!E?e=[document]:e=Array.isArray(E)?E:[E];for(let t of e){const r=De(t);r&&(t=r,t.addEventListener("mouseenter",_),t.addEventListener("mousemove",$),t.addEventListener("mouseleave",P),t.addEventListener("touchstart",I,{passive:!0}),t.addEventListener("touchmove",F,{passive:!0}),t.addEventListener("touchend",N,{passive:!0}),t.addEventListener("blur",W))}return()=>{for(let t of e){const r=De(t);r&&(t=r,t.removeEventListener("mouseenter",_),t.removeEventListener("mousemove",$),t.removeEventListener("mouseleave",P),t.removeEventListener("touchstart",I),t.removeEventListener("touchmove",F),t.removeEventListener("touchend",N),t.removeEventListener("blur",W))}}},[E,_,$,P,I,F,N,W,q]);const Se=n.useCallback(e=>{if(j.current||e.beta===null&&e.gamma===null)return;let t=S&&e.beta?h(e.beta,-S,S):v||0,r=G&&e.gamma?h(e.gamma,-G,G):b||0;qe&&(t=-t,r=-r),Y({angleX:t,angleY:r})},[S,G,v,b,qe,Y]);return n.useEffect(()=>{if(!(!S&&!G))return window.addEventListener("deviceorientation",Se),()=>window.removeEventListener("deviceorientation",Se)},[S,G,Se,f]),i.jsx("div",{ref:e=>{e&&(B.current=e,(v||b||p.current)&&y())},"data-testid":V?"container":void 0,style:Object.assign({display:"inline-block",width:o,height:a,borderRadius:c,perspective:l,transformStyle:"preserve-3d",backfaceVisibility:"hidden",filter:d?Dt:void 0},qt),onMouseEnter:R?ge?e=>{_(),ge(e)}:_:ge,onTouchStart:R?ye?e=>{I(),ye(e)}:I:ye,onMouseMove:R?ve?e=>{$(e),ve(e)}:$:ve,onTouchMove:R?xe?e=>{F(e),xe(e)}:F:xe,onMouseLeave:R?be?e=>{P(),be(e)}:P:be,onTouchEnd:R?ke?e=>{N(),ke(e)}:N:ke,onBlur:R?Me?e=>{W(),Me(e)}:W:Me,...Ht,children:i.jsx(Xt,{children:i.jsxs("div",{ref:T,"data-testid":V?"tilt":void 0,style:Object.assign({boxSizing:"border-box",position:"relative",width:"100%",height:"100%",borderRadius:c,transformStyle:"preserve-3d",backfaceVisibility:"hidden",transition:fe,transform:"rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)"},Vt),...Lt,children:[Yt,Rt&&i.jsx("div",{"data-testid":V?"spot-glare-container":void 0,style:{pointerEvents:"none",position:"absolute",inset:"0",borderRadius:c,overflow:"hidden",backfaceVisibility:"hidden",mixBlendMode:Tt},children:i.jsx("div",{ref:g,"data-testid":V?"spot-glare":void 0,style:{position:"absolute",left:"-100%",top:"-100%",width:"200%",height:"200%",filter:H?`blur(${Ge})`:void 0,transition:fe,backgroundImage:`radial-gradient(${Ct}, transparent)`,transform:"translateX(0%)",opacity:"0"}})}),s&&i.jsx("div",{"data-testid":V?"line-glare-container":void 0,style:{pointerEvents:"none",position:"absolute",inset:"0",borderRadius:c,overflow:"hidden",backfaceVisibility:"hidden",mixBlendMode:Et},children:i.jsx("div",{"data-testid":V?"line-glare":void 0,ref:w,style:{position:"absolute",left:0,top:"-50%",width:"200%",height:"200%",filter:H?`blur(${Ge})`:"",transition:fe,opacity:String(Gt),transform:`translateX(${O?"50%":"-100%"})`,backgroundImage:`linear-gradient(${wt==="to-bottom-right"?"to bottom right":"to bottom left"}, transparent, transparent ${U}%, ${Ee} calc(${U}% + 1px), ${Ee} ${Ve}%, transparent calc(${Ve}% + 1px), transparent 0%)`}})})]})})})});de.displayName="Tilt";try{de.displayName="Tilt",de.__docgenInfo={description:"",displayName:"Tilt",props:{width:{defaultValue:{value:"undefined"},description:"Width of the component\n@note You can also set the width using `className`, `style`, etc. instead of using this property\n@example 100, '200px', '10rem', '20%'",name:"width",required:!1,type:{name:"string | number"}},height:{defaultValue:{value:"undefined"},description:"Height of the component\n@note You can also set the height using `className`, `style`, etc. instead of using this property\n@example 100, '200px', '10rem', '20%'",name:"height",required:!1,type:{name:"string | number"}},borderRadius:{defaultValue:{value:"undefined"},description:`Border radius of the component (applied to glare elements as well)
...
}`,...(je=(Oe=Q.parameters)==null?void 0:Oe.docs)==null?void 0:je.source}}};var Be,_e,Ie;Z.parameters={...Z.parameters,docs:{...(Be=Z.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  parameters: {
    controls: {
      include: 'scale'
    }
...
//# sourceMappingURL=Tilt.stories-fa919c31.js.map
